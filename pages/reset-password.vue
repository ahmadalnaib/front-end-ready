...
const { sendPasswordConfirmation } = usePasswordConfirmation();
    ...
    <div class="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
      ...
      <form @submit.prevent="resetPassword">
        <div class="space-y-4">
          ...
          <button type="submit" class="w-full px-4 py-2 font-bold text-white bg-green-600 rounded-md hover:bg-green-700 focus:outline-none focus:ring focus:ring-indigo-200">Set Password</button>
        </div>
      </form>
